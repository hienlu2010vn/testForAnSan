<%-- 
    ...
    Created on : Jan 31, 2021, 2:59:19 PM
    Author     : hienl
--%>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-3">
                        ...
                        <div class="container">
                            <form action="HistoryUpdateController"> 
                        ...
                        <c:forEach var="item" items="${list}">
                            <div class="media">
                                ...
                                <div class="media-body">
                                    <h4 class="media-heading user_name">${item.email}</h4>
                                    ${item.updateContent}
                                </div>
                            </div>
                        </c:forEach>
            ...
            <nav aria-label="Page navigation example">
                <ul class="pagination">
                    <c:forEach begin="1" end="${totalPage}" var="pageNum">
                        <li class="page-item <c:if test="${currPage == pageNum}">disabled</c:if>"><a class="page-link" href="HistoryUpdateController?&pageNum=${pageNum}&name=${param.name}&searchDate=${param.searchDate}">${pageNum}</a>
                            </li>
                    </c:forEach>
                </ul>
            </nav>
